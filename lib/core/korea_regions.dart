// 대한민국 17개 시/도와 시/군/구 목록.
// Source: https://github.com/cosmosfarm/korea-administrative-district (2024-12-09 기준)
const Map<String, List<String>> kKoreaRegions = {
  ...
  '강원특별자치도': [
    '원주시', '춘천시', '강릉시', '동해시', '속초시', '삼척시', '홍천군', '태백시', '철원군', '횡성군',
  ...
  '경상남도': [
    '창원시', '김해시', '진주시', '양산시', '거제시', '통영시', '사천시', '밀양시', '함안군', '거창군',
  ...
  '전라남도': [
    '여수시', '순천시', '목포시', '광양시', '나주시', '무안군', '해남군', '고흥군', '화순군', '영암군',
    '영광군', '완도군', '담양군', '장성군', '보성군', '신안군', '장흥군', '강진군', '함평군', '진도군', '곡성군', '구례군',
  ],
  '제주특별자치도': ['제주시', '서귀포시'],
};
